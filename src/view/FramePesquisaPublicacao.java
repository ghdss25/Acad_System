...
public class FramePesquisaPublicacao extends JFrame {
...
//			public void run() {
//				try {
//					FramePesquisaPublicacao frame = new FramePesquisaPublicacao();
...
//	}
	 ...
	 * Create the frame.
	 */
	public FramePesquisaPublicacao(String nomeUsuario, String tipoUsuario) {
		...
		JButton btnListar = new JButton("Listar Publicações");
		...
		btnListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				controlePublicacao.listarPublicacoes(model);
			}
		});
		...
		scrollPane.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "Publica\u00E7\u00F5es Cadastradas", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 255, 255)));
		...
		btnPesquisarCurso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//controlePublicacao.pesquisarPublicacao(model, PesquisarField);
			}
		...
		PromptSupport.setPrompt("Digite o nome da Publicação", PesquisarField);
		...
		PesquisarField.setToolTipText("Digite o nome do Publicação");
