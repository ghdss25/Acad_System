...
public class FramePesquisaCurso extends JFrame {
...
//			public void run() {
//				try {
//					FramePesquisaCurso frame = new FramePesquisaCurso();
...
//	}
	 ...
	 * Create the frame.
	 */
	public FramePesquisaCurso(String nomeUsuario, String tipoUsuario) {
		...
		btnListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				controleCurso.listarCursos(model);
			}
		});
		...
		scrollPane.setBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "Cursos Cadastrados", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 255, 255)));
		...
		btnPesquisarCurso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				controleCurso.pesquisarCurso(model, PesquisarField);
			}
		...
		PromptSupport.setPrompt("Digite o nome do Curso", PesquisarField);
		...
		PesquisarField.setToolTipText("Digite o nome do Curso");
